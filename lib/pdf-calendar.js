 ...
 * @param locale {string}
 *
 * @return The PDF document generated.
 */
exports.generate = function(year, month, locale) {
    ...
    let font = fs.readFileSync(__dirname + "/../fonts/Ubuntu/Ubuntu-Bold.ttf");
    doc.font(font);
...
/**
 * Generate a PDF for the calendar of a given month of a given year and stores
 ...
 * @param locale {string}
 */
exports.generateFile = function(year, month, filename, locale) {
    let doc = exports.generate(year, month, locale);
